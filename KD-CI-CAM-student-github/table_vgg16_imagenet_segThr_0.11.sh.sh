...
python -u test_center_crop.py --gpu 3 --model_path ../CI-CAM-KD/save_model/net_train_vgg16_imagenet_0.pth --locTea 2 --cls_min_scale 0.4 --cls_max_scale 1.0 --loc_min_scale 0.9 --loc_max_scale 1.1 --kd_fe_loss 1 --kd_fe_zero 1 --kd_fe_times 1.0 --kd_alpha 0.8 --cls_teacher_T 2 --loc_teacher_T 2 --danet 0 --batch_size 48 --lr 0.000078 --epoch 20 --decay_epoch 10 --decay_rate 0.1 --backbone_rate 1.0 --update_rate 0.001 --backbone vgg16 --dataset imagenet --function sum_1 --mean_num 20 --seg_thr 0.11 --cls_teacher_input_size 288 --loc_teacher_input_size 288 >> log/table_6_imagenet_vgg16_gt_loc.txt 2>&1 &
