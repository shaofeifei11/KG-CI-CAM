...
class CUB_InceptionV3_NonLocal(nn.Module):
    def __init__(self, args):
        super(CUB_InceptionV3_NonLocal, self).__init__()
        self.num_classes = args.num_classes
        self.args = args
        backbone = Non_Local_InceptionV3(pretrain=cfg.pretrain)
    ...
    def compute_rois_up(self, seg_thr, topk, combination):
        ...
        return create_rois(self.pred_sort_up, self.pred_ids_up, self.up_cam, self.upsample, seg_thr=seg_thr, topk=topk,
                           combination=combination, function=cfg.function,
                           mean_num=cfg.mean_num)  # [batch, topk, 4]
