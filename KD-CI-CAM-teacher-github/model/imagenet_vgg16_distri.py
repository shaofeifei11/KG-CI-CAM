...
class ImageNet_VGG16_Distri(nn.Module):
    def __init__(self, args):
        super(ImageNet_VGG16_Distri, self).__init__()
        ...
        # self.up_feature_map, self.up_out, self.pred_sort_up, self.pred_ids_up, self.up_cam = None, None, None, None, None
        # self.down_feature_map, self.down_out, self.pred_sort_down, self.pred_ids_down, self.down_cam = None, None, None, None, None
